...
public class DictionaryLLTester {
	...
	@Test
	public void testDictLL()
	{
		dictLL.addWord("tEst");
		assertEquals("Testing size for dictLL", 1, dictLL.size());
		dictLL.addWord("second");
		assertEquals("Testing size for dictLL", 2, dictLL.size());
		dictLL.addWord("teSt");
		assertEquals("Testing size for dictLL", 2, dictLL.size());
		assertEquals("Testing isWord ", true, dictLL.isWord("teST"));
		assertEquals("Testing isWord ", false, dictLL.isWord("soup"));

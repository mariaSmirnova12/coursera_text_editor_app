...
public class DictionaryBSTTester {
	...
	@Test
	public void testDictBST() {

		Dictionary dictBST = new DictionaryBST();

		dictBST.addWord("tEst");
		assertEquals("Testing size for dictBST", 1, dictBST.size());
		dictBST.addWord("second");
		assertEquals("Testing size for dictBST", 2, dictBST.size());
		dictBST.addWord("teSt");
		assertEquals("Testing size for dictBST", 2, dictBST.size());
		assertEquals("Testing isWord ", true, dictBST.isWord("teST"));
		dictBST.addWord("seconds");
		dictBST.addWord("seconded");
		dictBST.addWord("secondhand");
		dictBST.addWord("selma");
		assertEquals("Testing isWord ", true, dictBST.isWord("seconded"));
		assertEquals("Testing isWord ", true, dictBST.isWord("selma"));
		assertEquals("Testing isWord ", false, dictBST.isWord("soup"));
	}
}

...
public class AutoCompleteDictionaryTrieTester {
	...
	public void setUp()
	{
		...
		loader.loadFromFileToDictionary(largeDict, dictFile);
	...
	public void testSize()
	{
		...
		assertEquals("Testing size", 24, ac.size());
		ac.addWord("dog");
		assertEquals("Testing size", 24, ac.size());
	}
	...
	public void testIsWord()
	{
		...
		assertEquals("Testing isWord ", false, ac.isWord(""));
		assertEquals("Testing isWord ", true, ac.isWord("doggoes"));
		assertEquals("Testing isWord ", false, ac.isWord("downhil"));
		assertEquals("Testing isWord ", false, ac.isWord("downhille"));
		assertEquals("Testing isWord ", true, ac.isWord("test"));
		assertEquals("Testing isWord ", true, ac.isWord("testone"));
	}
